...
Command: npx gltfjsx@6.2.16 r2d2.glb --transform -T 
Files: r2d2.glb [30.99MB] > S:\Repository\portfolio\dist\r2d2\r2d2-transformed.glb [1.75MB] (94%)
...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/r2d2-transformed.glb')
  const { actions } = useAnimations(animations, group)
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="_D2_R2Body_NeutralPose" position={[0, 0.227, 0]} scale={0.209}>
        ...
        <mesh name="_D2_R2Left_Foot_Left_FootMat_0" geometry={nodes._D2_R2Left_Foot_Left_FootMat_0.geometry} material={materials.Left_FootMat} position={[0.005, 0, 0.006]} scale={0.008} />
      </group>
    </group>
  )
}

useGLTF.preload('/r2d2-transformed.glb')
